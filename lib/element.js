 ...
 * @param {(Array|string)} newClass - Array or string of class to add to a DOM Element.
 * @param {Element} element - Element to apply the changes.
 * @returns {Element} element that the changes were made.
 * @example
 ...
 * @param {(Array|string)} classToRemove - Array or string of class to remove of a DOM Element.
 * @param {Element} element - Element to apply the changes.
 * @returns {Element} element that the changes were made.
 * @example
 ...
 * @param {(Array|string)} classToCheck - Array or string of class to check the existence in a DOM Element.
 * @param {Element} element - Element to apply the changes.
 * @returns {Element} element that the changes were made.
 * @example
